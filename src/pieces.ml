...
module Pawn : PIECE = struct
  let t = {name = "pawn"; value = 1; loc = (1, 1); captured = false; moves = []; color = "black"}
  let name = t.name
...
module Bishop : PIECE = struct
  let t = {name = "bishop"; value= 3 ; loc = ('A', 1) ; captured= false; moves = []; color = "black"}
(** The type that represents the piece. [name] is the name of the piece. [value] is the amount of points the piece is worth
    [loc] is the location of the piece. [captured] is whether the piece is captured or not *)
...
module Knight : PIECE = struct
  let t = {name = "knight"; value= 3 ; loc = ('A', 1) ; captured= false; moves = []; color = "black"}
(** The type that represents the piece. [name] is the name of the piece. [value] is the amount of points the piece is worth
    [loc] is the location of the piece. [captured] is whether the piece is captured or not *)
...
module Rook : PIECE = struct
  let t = {name = "rook"; value = 5 ; loc = ('A', 1) ; captured = false; moves = []; color = "black"}
(** The type that represents the piece. [name] is the name of the piece. [value] is the amount of points the piece is worth
    [loc] is the location of the piece. [captured] is whether the piece is captured or not *)
...
module Queen : PIECE = struct
  let t = {name = "queen"; value= 9 ; loc = ('A', 1) ; captured= false; moves = []; color = "black"}
(** The type that represents the piece. [name] is the name of the piece. [value] is the amount of points the piece is worth
    [loc] is the location of the piece. [captured] is whether the piece is captured or not *)
...
module King : PIECE = struct
  let t = {name = "king"; value= inf ; loc = ('A', 1) ; captured= false; moves = []; color = "black"}
  let name = t.name
  let value = t.value
  let loc = t.loc
  let captured = t.captured
